...
import { checkLocalInteractions } from "@/services/localInteractions";
...
const InteractionChecker = () => {
  ...
  const handleAddDrug = (drug: DrugSearchResult) => {
    console.log("Attempting to add drug:", drug);
    if (!drug || !drug.name) {
      console.error("Invalid drug object:", drug);
      return;
    }
    ...
    console.log("New selected drugs list:", newDrugs);
  ...
  const analyzeInteractions = async () => {
    ...
    try {
      // --- AI-ONLY MODE ---
      console.log("Analyzing drugs (AI Mode):", selectedDrugs);
